...
import { Menu, X, Code2, Bitcoin, Smartphone, ChevronDown } from 'lucide-react';
            ...
            <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '72px' }}>
                ...
                <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'center' }} className="desktop-menu">
                    ...
                    <Link to="/cripto" style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                        <Bitcoin size={14} color="#f7931a" /> Cripto
                    </Link>

                    <Link to="/apps" style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                        <Smartphone size={14} color="var(--accent)" /> Apps
                    </Link>
            ...
            {isOpen && (
                <div style={{
                    ...
                    {[
                        ...
                        { to: '/blog', label: '📰 Blog' },
                        { to: '/cripto', label: '₿ Cripto' },
                        { to: '/apps', label: '📱 Apps em Alta' },
                        { to: '/contato', label: '✉️ Contato' },
